...
import { AI_FAQS } from "./data";

export default function AiFaq() {
  const [open, setOpen] = useState<number | null>(0);

  return (
    <section className="relative py-24 lg:py-32" aria-labelledby="ai-faq-title">
      <div className="mx-auto max-w-3xl px-5 sm:px-8">
        <SectionHeader
          ...
          title="Questions?"
          highlight="Answered."
          subtitle="Everything students ask about the AI tools, data and their journey."
        />
